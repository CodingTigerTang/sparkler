...
**Sparkler** is an R package designed to bring joy, delight, and atmosphere to your Shiny apps, R Markdown documents, and Quarto presentations.

**Sparkler** provides lightweight visual effects: **Confetti**, **Fireworks**, and **Atmospheric Weather**. Effects can be used as full-screen overlays or, for selected effects, inside contained regions.
...
Using Sparkler in Shiny depends on the effect. Celebration effects such as confetti and fireworks are often used as overlay-style outputs that can be triggered from server logic. Weather effects can be used either as fullscreen overlays or inside a visible output region.
...
## 📄 How to Use in R Markdown / Quarto
